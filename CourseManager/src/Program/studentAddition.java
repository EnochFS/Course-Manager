...
public class studentAddition {
    ...
    public void finalizeProfile(ActionEvent actionEvent) throws SQLException {
       ...
       if(firstNameString.isEmpty() || lastNameString.isEmpty() || userNameString.isEmpty() || firstPassString.isEmpty() ||
        confPassString.isEmpty()){
           ...
           AlertBox.display("Notice", "The User id must be 5 characters long");
       }else{
           try {
    Connection conn = null;
    String url = "jdbc:sqlite:Login.db";
    conn = DriverManager.getConnection(url);
    String query = "INSERT INTO StudentInformation(First, Last, Username, id, Password, Gender) VALUES(?, ?, ?, ?, ?, ?)";
